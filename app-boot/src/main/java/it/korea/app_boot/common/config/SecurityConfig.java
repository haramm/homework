...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web.ignoring()
                        ...
                        .requestMatchers("/plugins/**", "/js/**", "/static/imgs/**", "/static/img/**")
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeRequests(
                    auth ->
                        ...
                        .anyRequest().authenticated()  // 나머지 request 전부 인증 처리
                )   
                .formLogin(
                    form ->
                ...
                .logout(
                    out ->
                        ...
                        .deleteCookies("JSEESIONID") // 세션 id 제거
    ...
    //auth provider 생성해서 전달 > 사용자가 만든걸 전달함
    @Bean
